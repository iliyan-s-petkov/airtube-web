...
func (s *blockingSource) SensorSeries(_ context.Context, _ int64, _ string, _ time.Time, _ *time.Time, _ bool, _ time.Duration) ([]store.Point, error) {
	return nil, nil
}

func (s *blockingSource) AreaSeries(_ context.Context, _, _ string, _ time.Time, _ *time.Time, _ bool, _ time.Duration) ([]store.Point, error) {
	return nil, nil
}
