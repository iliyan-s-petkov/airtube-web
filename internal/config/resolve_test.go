...
func TestResolveCommittedConfig(t *testing.T) {
	...
	if got, want := cfg.RateLimit.Enumerate.AreasPerWindow, 60; got != want {
		t.Errorf("Enumerate.AreasPerWindow = %d, want %d", got, want) // raised from 12 to 20 to 60, see docs/superpowers/specs/2026-08-17-airbg-deployment-design.md
	}
