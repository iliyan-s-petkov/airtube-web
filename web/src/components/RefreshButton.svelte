<script>
  ...
  //
  // Two dresses for one control, because the kit gives it two homes. On the map
  // home it is a toolbar control on the finder's baseline, solid-bordered and
  // full height; on an area page it sits inside the freshness line itself, so
  // it is ghost and compact — chrome beside data, not a page action. Same
  // button, same behaviour, one prop.
